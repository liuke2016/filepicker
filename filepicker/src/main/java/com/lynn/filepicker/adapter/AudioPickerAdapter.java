...
public class AudioPickerAdapter extends BasePickerAdapter<AudioFile> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        icAudio.setPadding(Util.dip2px(10),0,0,0);
        ...
        llContainer.setPadding(Util.dip2px(10),Util.dip2px(10),Util.dip2px(10),Util.dip2px(10));
        ...
        tvDuration.setPadding(0,Util.dip2px(5),0,0);
